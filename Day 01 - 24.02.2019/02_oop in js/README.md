...
```javascript
class Animal {
    static test(){ console.log(`We have already ${Animal.num} animals`);}
    static num=0;
    constructor(age) {
        Animal.num++;
        this.name = "Animal"
...
Animal.test();          //--> We have already 0 animals
let z=new Animal(2);    //--> new Animal was born
Animal.test();          //--> We have already 1 animals
```
